# Contributing to OpenFlight Repository Manager

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to OpenFlight Repository Manager? Welcome! Please read this
...
You can help OpenFlight Repository Manager by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/opoenflight-repo/issues?state=open)
...
If you find a bug - behaviour of OpenFlight Repository Manager code or documentation
...
[GitHub issue tracker for OpenFlight Repository Manager](https://github.com/openflighthpc/opoenflight-repo/issues/new)
to report the issue.
...
We want to improve the quality of OpenFlight Repository Manager and good bug reports are
...
OpenFlight Repository Manager is Open Source and comes without warranty.
...
OpenFlight Repository Manager in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of OpenFlight Repository Manager and really improve it. The more
...
applied to OpenFlight Repository Manager itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/opoenflight-repo). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the OpenFlight Repository Manager developers also have their regular
